...
The `useEventListener` hook provides a simple way to add event listeners to DOM elements, the window, or document with automatic cleanup when the component unmounts. It handles all the boilerplate of adding and removing event listeners safely.
...
function ResponsiveComponent() {
  ...
  return (
    <div>
      ...
      <div
        className={windowSize.width < 768 ? "mobile-layout" : "desktop-layout"}
      >
