---
title: Installation
description: How to install and use react-usekit hooks and helpers in your project
---
...
```package-install
shadcn@latest add "https://react-usekit.vercel.app/r/[hooks/helper-name].json"
```
